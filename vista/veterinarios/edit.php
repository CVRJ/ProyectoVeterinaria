...
<?php if(count($data)>0):?>
    <?php foreach($data as $d):?>
                        <form method="POST"  autocomplete="off" action="editarRegistro?id=<?php echo $d->id_vet; ?>">
                            <div class="row clearfix">
                                <div class="col-sm-3">
                                    <label class="control-label">DNI del veterinario</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="dnivet" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="8" value="<?php echo $d->dnivet; ?>"  class="form-control" placeholder="DNI del veterinario..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" value="<?php echo $d->nomvet; ?>" name="nomvet" required class="form-control" placeholder="Nombre del veterinario..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="apevet" value="<?php echo $d->apevet; ?>" required class="form-control" placeholder="Apellido del veterinario..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <label class="control-label">Correo del veterinario</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                ...
                                <div class="col-sm-3">
                                    <label class="control-label">Telefono movil del veterinario</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                ...
                                <div class="col-sm-3">
                                    <label class="control-label">Telefono fijo del veterinario</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                ...
                                <div class="col-sm-4">
                                    <label class="control-label">Usuario del veterinario</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="usuario" value="<?php echo $d->usuario; ?>" required class="form-control" placeholder="Usuario..." />
                                        </div>
                                    </div>
                                </div>
                            </div>
