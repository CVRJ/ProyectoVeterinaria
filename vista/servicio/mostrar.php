...
<td><?php    
                ...
                if($va['estado']==1)  { ?> 
                <form  method="get" action="javascript:activo('<?php echo $va['id_servi']; ?>')">
                   
                    <span class="label label-success">Activo</span>
                </form>
                <?php  }   else {?> 

                    <form  method="get" action="javascript:inactivo('<?php echo $va['id_servi']; ?>')"> 
                        <button type="submit" class="btn btn-danger btn-xs">Inactivo</button>
                     </form>
                        <?php  } ?></td> 

<td><a type="button" href="../vista/servicio/edit?id=<?php echo $va["id_servi"]; ?>"  class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
                    <i class="material-icons">autorenew</i>
                </a>
                <a type="button" href="../vista/servicio/borrar?id=<?php echo $va["id_servi"]; ?>"  class="btn bg-red btn-circle waves-effect waves-circle waves-float">
