    ...
    <div class="row clearfix">
        <div class="col-sm-3">
            ...
            <div class="input-group">
                ...
                <div class="form-line">
                    <input type="text" value="<?php echo $d->precio; ?>" name="precio" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" class="form-control money-euro" placeholder="Precio... Ex: $1000">
                </div>
            </div>
        </div>
