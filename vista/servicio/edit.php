...
<?php if(count($data)>0):?>
    <?php foreach($data as $d):?>
                        <form method="POST"  autocomplete="off" action="editarRegistro?id=<?php echo $d->id_servi; ?>">
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <label class="control-label">Nombre del servicio</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nomser" value="<?php echo $d->nomser; ?>"  class="form-control" placeholder="Nombre del servicio..." />
                                        </div>
                                    </div>
                                </div>
                            </div>
