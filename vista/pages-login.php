...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Login | Proyecto Veterinaria</title>
    <link
...
?>
              <label class="block text-sm">
                ...
                <input
                  ...
                  placeholder="Nombre" name="usuario" value="<?php if(isset($_POST['usuario'])) echo $_POST['usuario'] ?>" autocomplete="off"
                />
              </label>
